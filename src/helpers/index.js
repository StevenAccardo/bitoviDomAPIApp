...
//Exported functions and class at the bottom
...
const createDataList = (newIndex, nameArr) => {
...
//Builds up the input
const buildInput = (inputEl, placeholder, newIndex) => {
...
const insertDataList = (inputEl, newDataList) => {
  const input = document.querySelector(inputEl);
...
export const buildSearch = (inputEl, placeholder, teamData) => {
  if (inputEl && teamData) {
    ...
    const newDataList = createDataList(newIndex, nameArr);
...
export const buildProfile = (inputEl, parentSel, teamData) => {
  ...
  const createProfile = value => {
    ...
    const selectedMember = teamData.filter(member => member.name === value);
      ...
      switch (prop) {
        ...
        case 'twitter':
          if (selectMemObj[prop]) {
            ...
            twitterATag.setAttribute('href', selectMemObj[prop]);
        ...
        case 'github':
          if (selectMemObj[prop]) {
            ...
            githubATag.setAttribute('href', selectMemObj[prop]);
